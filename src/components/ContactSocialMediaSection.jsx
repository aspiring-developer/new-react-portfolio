...
export const ContactSocialMediaSection = () => {
  return (
    <>
      <p className="aboutPara text-info"> Contact me for further inquiry if... <br /> you find any matching skills needed for your facility. </p>
      <p className="aboutPara"> Cary • North Carolina &bull; 919-793-4494 &bull; shivash05@gmail.com </p>
